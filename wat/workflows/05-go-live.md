...
## Output (deliverables/)
1. `00-app-overview.md` — what CarrierVet is, who it's for, key features (1 page)
...
## Commit
`git add -A && git commit -m "tutorial(05-carriervet): GO — long-form package ready"` — no push.
