# Tutorial: Freight Matcher — WAT Project

## Mission
Produce a complete long-form video tutorial production package for **Freight Matcher** (app #04 of 7 in the Logistics Suite, left-to-right on `app.html`). Output goes to `deliverables/`.

## Source app
- File: `C:/Users/aleca/Desktop/Logistics Suite/Logistics-Suite/site/freight-matcher.html`
- One-line description: Truck-to-load matching tool
...
- Final commit on `tutorial/04-freight-matcher` branch
