# Tutorial: Pillar — WAT Project

## Mission
Produce a complete long-form video tutorial production package for **Pillar** (app #07 of 7 in the Logistics Suite, left-to-right on `app.html`). Output goes to `deliverables/`.

## Source app
- File: `C:/Users/aleca/Desktop/Logistics Suite/Logistics-Suite/site/pillar.html`
- One-line description: Uploaded via Supabase upload-app API
...
- Final commit on `tutorial/07-pillar` branch
