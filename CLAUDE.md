# Tutorial: Data Wash — WAT Project

## Mission
Produce a complete long-form video tutorial production package for **Data Wash** (app #06 of 7 in the Logistics Suite, left-to-right on `app.html`). Output goes to `deliverables/`.

## Source app
- File: `C:/Users/aleca/Desktop/Logistics Suite/Logistics-Suite/site/data-wash.html`
- One-line description: Data cleaning utility for freight CSVs
...
- Final commit on `tutorial/06-data-wash` branch
