# Tutorial: Bolt Post — WAT Project

## Mission
Produce a complete long-form video tutorial production package for **Bolt Post** (app #02 of 7 in the Logistics Suite, left-to-right on `app.html`). Output goes to `deliverables/`.

## Source app
- File: `C:/Users/aleca/Desktop/Logistics Suite/Logistics-Suite/site/bolt-post.html`
- One-line description: Companion high-throughput bulk-post app
...
- Final commit on `tutorial/02-bolt-post` branch
