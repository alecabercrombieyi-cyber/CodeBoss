# Tutorial: Load Manager — WAT Project

## Mission
Produce a complete long-form video tutorial production package for **Load Manager** (app #03 of 7 in the Logistics Suite, left-to-right on `app.html`). Output goes to `deliverables/`.

## Source app
- File: `C:/Users/aleca/Desktop/Logistics Suite/Logistics-Suite/site/load-manager.html`
- One-line description: Single-file freight load management app
...
- Final commit on `tutorial/03-load-manager` branch
