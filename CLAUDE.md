# Tutorial: Mass Post — WAT Project

## Mission
Produce a complete long-form video tutorial production package for **Mass Post** (app #01 of 7 in the Logistics Suite, left-to-right on `app.html`). Output goes to `deliverables/`.

## Source app
- File: `C:/Users/aleca/Desktop/Logistics Suite/Logistics-Suite/site/mass-post.html`
- One-line description: Bulk DAT load posting + rate management
...
- Final commit on `tutorial/01-mass-post` branch
